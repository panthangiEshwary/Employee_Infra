resource "aws_instance" "monitor_instance" {
  ...
  user_data = templatefile("${path.module}/userdata.sh", {
    ...
    alert_rules_config  = templatefile("${path.module}/alert-rules.yml.tpl", {})
    alertmanager_config = templatefile("${path.module}/alertmanager.yml.tpl", {})
    docker_compose      = templatefile("${path.module}/docker-compose.yml.tpl", {})
  })
